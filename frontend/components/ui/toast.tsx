  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        variant === "destructive" && "bg-red-600 text-white border-red-600 group",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-gray-600 opacity-70 transition-opacity hover:opacity-100 focus:opacity-100 focus:outline-none focus:ring-2 group-[.destructive]:text-white",
      className
    )}
    toast-close=""
    {...props}
